...
import com.dsquare.covid19tracker.Adapters.StateWiseAdapter;
...
public class StateWiseDataActivity extends AppCompatActivity {
    ...
    private ArrayList<StateWiseModels> stateWiseModelArrayList;
    ...
    private void Filter(String text) {
        ArrayList<StateWiseModels> filteredList = new ArrayList<>();
        for (StateWiseModels item : stateWiseModelArrayList) {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 1; i < jsonArray.length(); i++) {
                                ...
                                StateWiseModels stateWiseModel = new StateWiseModels(str_state, str_confirmed, str_confirmed_new, str_active,
